...
<div>
      ...
      <section id="welcome">
        ...
        <p>Soy un desarrollador web junior apasionado por crear aplicaciones web modernas y eficientes.</p>
      </section>
      ...
      <section id="testimonials">
        <h2>Testimonios</h2>
        <blockquote>
          <p>"[Tu Nombre] es un desarrollador talentoso y dedicado, siempre dispuesto a aprender y mejorar."</p>
