...
import TimelineComponent from '../../Componentes-Generales/timeline.jsx';
        ...
        <center>
          ...
          <section id="CV_text">
            ...
            <p>
              ...
              escena en el mundo de la tecnología. Ahora, como Soporte de
              Aplicaciones, estoy aplicando y ampliando mis habilidades
              técnicas, al mismo tiempo que aprendo sobre el desarrollo de
              software. Estoy constantemente buscando formas de mejorar la
              eficiencia y la eficacia de las aplicaciones con las que trabajo.
              En cuanto a mi formación académica, estoy estudiando Desarrollo
              Web. Este camino me ha permitido profundizar en el fascinante
              mundo de la programación y el diseño web. Estoy ansioso por
              aplicar lo que he aprendido en proyectos reales y contribuir a
              crear soluciones web innovadoras. Soy una persona proactiva,
              siempre dispuesta a aprender cosas nuevas y a enfrentar desafíos.
              Creo firmemente que la tecnología tiene el poder de cambiar el
              mundo y estoy emocionado de ser parte de ese cambio. Gracias por
