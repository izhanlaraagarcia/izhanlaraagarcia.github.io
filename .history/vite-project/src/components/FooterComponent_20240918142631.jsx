    ...
    >
      <div className="footer-content">
        ...
        <div className="contact-form">
          ...
          <form>
            <input type="text" placeholder={language === 'en' ? "Your Name" : "Tu Nombre"} required />
            <input type="email" placeholder={language === 'en' ? "Your Email" : "Tu Correo Electrónico"} required />
            <textarea placeholder={language === 'en' ? "Your Message" : "Tu Mensaje"} required></textarea>
            <motion.button 
              type="submit"
