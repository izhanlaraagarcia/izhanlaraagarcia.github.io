...
import { IoIosFlag } from 'react-icons/io'; // Importar iconos para las banderas
        ...
        <ul className="nav-list">
          ...
          <li className="lang-btn-wrapper">
            <button className="lang-btn" onClick={toggleLanguage}>
              {language === 'en' ? (
                <IoIosFlag className="flag-icon" title="Español" />
              ) : (
                <IoIosFlag className="flag-icon" title="English" />
              )}
            </button>
          </li>
        </ul>
