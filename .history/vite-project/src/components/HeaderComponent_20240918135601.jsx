...
>
  ...
  <motion.a
    href="/path-to-cv.pdf"  // Cambia esta ruta por la ruta correcta de tu CV
    download="Izhan_Lara_Garcia_CV.pdf"  // Descarga directa
  ...
  {/* Botón que redirige al portafolio */}
  <motion.a
    href="/portfolio"  // Cambia esta ruta por la ruta correcta de tu portafolio
    className="btn btn-glow"
    whileHover={{ scale: 1.1, backgroundColor: "#fff", color: "#ff6bcb" }}
  >
...
>
  <motion.a href="https://linkedin.com" target="_blank" whileHover={{ scale: 1.3 }}><FaLinkedin /></motion.a>
  <motion.a href="https://github.com" target="_blank" whileHover={{ scale: 1.3 }}><FaGithub /></motion.a>
  <motion.a href="https://twitter.com" target="_blank" whileHover={{ scale: 1.3 }}><FaTwitter /></motion.a>
</motion.div>
