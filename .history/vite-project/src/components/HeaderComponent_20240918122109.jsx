    ...
    <>
      <header className="header" id="header">
        ...
        >
          ...
          >
            <motion.a href="https://www.linkedin.com/in/izhan-lara-garcia" target="_blank" whileHover={{ scale: 1.2 }}><FaLinkedin /></motion.a>
            <motion.a href="https://github.com/izhanlaraagarcia" target="_blank" whileHover={{ scale: 1.2 }}><FaGithub /></motion.a>
          </motion.div>
        </motion.div>
      </header>
