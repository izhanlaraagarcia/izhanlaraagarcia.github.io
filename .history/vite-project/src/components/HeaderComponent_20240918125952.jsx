      ...
      <header className="header" id="header">
        <nav className="nav">
          <ul className="nav-list">
            ...
            {/* Nuevo enlace a la página de Blog */}
            <li><a href="/blog" target="_blank" rel="noopener noreferrer">{translations[language].blog}</a></li>
        ...
        {/* Animaciones suaves y contenido del header */}
        <motion.div 
